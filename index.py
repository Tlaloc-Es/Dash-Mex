...
def get_index_page():
    ...
    return html.Div(
        ...
        * http://www.diputados.gob.mx/documentos/Congreso_Nacional_Legislativo/Doc/CMD_Integrado.pdf
        ...
        Los delitos como se puede ver a continuación estan divididos en varias categorías con sus propias subclases, de la siguiente manera:
        """),
        ...
        * Dataset: Porcentaje y número de personas en los elementos de los indicadores de carencia social, según entidad federativa, 2008-2018, parte III
        ...
        * Dataset: Porcentaje y número de personas en los elementos de los indicadores de carencia social, según entidad federativa, 2008-2018, parte IV
