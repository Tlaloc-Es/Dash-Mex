...
app = Dash(__name__, external_stylesheets=[dbc.themes.LUX, FA])
app.config.suppress_callback_exceptions = True
server = app.server

with open(BASE_DIR / 'data' / 'geo' / 'estados.geojson', encoding='utf-8') as f:
    STATES = json.load(f)
...
def get_socioeconomic_data():
    ...
    data_dir = BASE_DIR / 'data' / 'economia'
    return {
